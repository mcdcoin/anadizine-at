<?php
	...
	** ****** *********************************** */
	...
	$ClientArea -> setPageTitle("Minecraft Sunucular");
	$ClientArea -> addToBreadCrumb("index.php", Lang::trans("globalsystemname"));
	$ClientArea -> addToBreadCrumb("minecraft.php", "İster Windows, İster Linux ihtiyacına uygun olanı seç.");
	...
	$ClientArea -> setTemplate("minecraft");
