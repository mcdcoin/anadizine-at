<?php
	...
	** ****** *********************************** */
	...
	$ClientArea -> setPageTitle("Insurgency Sunucular");
	$ClientArea -> addToBreadCrumb("index.php", Lang::trans("globalsystemname"));
	$ClientArea -> addToBreadCrumb("insurgency.php", "İster Windows, İster Linux ihtiyacına uygun olanı seç.");
	...
	$ClientArea -> setTemplate("insurgency");
