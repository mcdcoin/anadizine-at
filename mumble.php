<?php
	...
	** ****** *********************************** */
	...
	$ClientArea -> setPageTitle("Mumble Sunucular");
	$ClientArea -> addToBreadCrumb("index.php", Lang::trans("globalsystemname"));
	$ClientArea -> addToBreadCrumb("mumble.php", "İster Windows, İster Linux ihtiyacına uygun olanı seç.");
