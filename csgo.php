<?php
	...
	** ****** *********************************** */
	...
	$ClientArea -> setPageTitle("Counter Strike Global Offensive Sunucular");
	$ClientArea -> addToBreadCrumb("index.php", Lang::trans("globalsystemname"));
	$ClientArea -> addToBreadCrumb("csgo.php", "İster Windows, İster Linux ihtiyacına uygun olanı seç.");
