<?php
	...
	** ****** *********************************** */
	...
	$ClientArea -> setPageTitle("Team Fortress 2 Sunucular");
	$ClientArea -> addToBreadCrumb("index.php", Lang::trans("globalsystemname"));
	$ClientArea -> addToBreadCrumb("teamfortress.php", "İster Windows, İster Linux ihtiyacına uygun olanı seç.");
	...
	$ClientArea -> setTemplate("teamfortress");
