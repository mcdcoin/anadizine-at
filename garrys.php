<?php
	...
	** ****** *********************************** */
	...
	$ClientArea -> setPageTitle("Garry's Mod Sunucular");
	$ClientArea -> addToBreadCrumb("index.php", Lang::trans("globalsystemname"));
	$ClientArea -> addToBreadCrumb("garrys.php", "İster Windows, İster Linux ihtiyacına uygun olanı seç.");
