<?php
	...
	** ****** *********************************** */
	...
	$ClientArea -> setPageTitle("Rust Sunucular");
	$ClientArea -> addToBreadCrumb("index.php", Lang::trans("globalsystemname"));
	$ClientArea -> addToBreadCrumb("rust.php", "İster Windows, İster Linux ihtiyacına uygun olanı seç.");
