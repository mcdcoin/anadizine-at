<?php
	...
	** ****** *********************************** */
	...
	$ClientArea -> setPageTitle("TeamSpeak 3 Sunucular");
	$ClientArea -> addToBreadCrumb("index.php", Lang::trans("globalsystemname"));
	$ClientArea -> addToBreadCrumb("teamspeak.php", "İster Windows, İster Linux ihtiyacına uygun olanı seç.");
	...
	$ClientArea -> setTemplate("teamspeak");
